<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Mission.aspx.cs" Inherits="WebFormsEmailSMS2FA.Mission" %>
...
.pageStart
{
    ...
    <div class="container">
        <div class="row">
                <div class="col-md-12">
                        <h1 class="heading">G.A.P™ – MISSION STATEMENT</h1>
                        <p class="para1">
                            Ghazi Aesthetics Program (G.A.P™) is an education, networking and training platform to develop skills, delivery of safe and effective services in medical Aesthetics, and  promote collaboration between all stakeholders
