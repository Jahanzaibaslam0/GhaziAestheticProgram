<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateRegistrationForm.aspx.cs" Inherits="WebFormsEmailSMS2FA.UpdateRegistrationForm1" %>
...
<div class="row">
    ...
    <div class="col-md-6">
      ...
      <%--<asp:CheckBox ID="chkBoxOnline" Text="Online Deposite" runat="server" />--%>
        ...
        <asp:Button ID="Button1" runat="server" Text="Cancel" Width="150px" Height="39.41px" ForeColor="White" BackColor="#ff0000" OnClick="Button1_Click1" />
