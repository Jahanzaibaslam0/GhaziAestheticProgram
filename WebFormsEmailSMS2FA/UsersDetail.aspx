<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UsersDetail.aspx.cs" Inherits="WebFormsEmailSMS2FA.UsersDetail" %>
...
<asp:ScriptManagerProxy runat="server" />   
    ...
    <hr />--%> 
    <asp:GridView ID="User1" runat="server" AutoGenerateColumns="False" AllowPaging="true" OnPageIndexChanging="User1_PageIndexChanging" PagerSettings-FirstPageText="First" PagerSettings-Mode="NumericFirstLast" PagerSettings-LastPageText="Last" CellPadding="4" 
        ForeColor="#333333"  style="width:98%" PageSize="5">
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Password1" HeaderText="Password" ItemStyle-Width="100px" >
            <ItemStyle Width="100px"></ItemStyle>
        </asp:BoundField>
        <asp:BoundField DataField="Email2" HeaderText="Email Verified" ItemStyle-Width="100px" >
            <ItemStyle Width="100px"></ItemStyle>
        </asp:BoundField>
        <asp:BoundField DataField="PMDC2" HeaderText="PMDC Verified" ItemStyle-Width="100px" >
            <ItemStyle Width="100px"></ItemStyle>
        </asp:BoundField>
        <asp:BoundField DataField="PHONENo2" HeaderText="MOBILE Verified" ItemStyle-Width="100px" >
            <ItemStyle Width="100px"></ItemStyle>
        </asp:BoundField>
