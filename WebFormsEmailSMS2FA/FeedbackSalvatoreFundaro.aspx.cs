...
{
    public partial class FeedbackSalvatoreFundaro : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //conn.Open();
            string sQuery = string.Format("INSERT INTO YvoireFeedback (FAContent,FASpeaker,AOFContent,AOFSpeaker,TPContent,TPSpeaker,WhyChooseYvioreContent,WhyChooseYvioreSpeaker,[Which part did you like the most in Ghazi Aesthetics Program (G.A.P) Workshop?],[Which part of Workshop would you suggest for improvement?],[What are the topics you look forward to in Ghazi Aesthetics Program (G.A.P) next coming workshop?],RegID,createddate,DoctorName,ClinicName,MobileNumber,Email,City) Values (@FAContent,@FASpeaker,@AOFContent,@AOFSpeaker,@TPContent,@TPSpeaker,@WhyChooseYvioreContent,@WhyChooseYvioreSpeaker,@Q1,@Q2,@Q3,@RegID,@createddate,@DoctorName,@ClinicName,@MobileNumber,@Email,@City)");
            ...
            cmd.Parameters.AddWithValue("@AOFContent", AOFContent.SelectedItem.Value);
            cmd.Parameters.AddWithValue("@AOFSpeaker", AOFSpeaker.SelectedItem.Value);
