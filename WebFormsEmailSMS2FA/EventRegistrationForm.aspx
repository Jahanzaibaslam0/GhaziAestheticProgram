<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventRegistrationForm.aspx.cs" Inherits="WebFormsEmailSMS2FA.WebForm6" %>
...
<body class="body" >
    <form id="form2" runat="server" style="align-content:center" >
        <img src="Images/FootLogo.PNG" style="align-content:center;padding-left:400px" />
    ...
    <div class="container" style="background-color:#1f1e6a;border-style:dashed;border-width:medium;padding:10px,10px,500px,500px;border-spacing:initial ;align-content:start; font-style:normal;color:aliceblue" >
        <div class="borders" style="align-content:normal">
            <div class="row" >
                <div class="col-md-6" style="background-color:#1f1e6a ;align-content:center; font-size-adjust:initial">
                    <%--<h1 class="login"><%: Title %></h1>--%>
                    <h1 class="login hr" style="align-content:center;height:70px ;padding-top:20px;padding-bottom:30px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; SIGN UP</h1>
            ...
            <div class="row">
                <div class="myDiv" ></div>
                <div class="myDiv" style="background-color:#312f90">
                    ...
                    <%--</div>--%>
                     ...
                     <div class="form-group"  >
                        ...
                        <asp:TextBox runat="server" ID="txtEmail" STYLE="width:50%;height:40px; border-radius: 5px;" TextMode="Email" CssClass="form-control"   />
                         <br />
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtEmail" ForeColor="Red" CssClass="text-danger" ErrorMessage="The email field is required." />
                    </div>
                     ...
                     <div class="form-group" >
                        ...
                        <asp:TextBox runat="server" ID="txtPhoneNumber" TextMode="Number" STYLE="width:50%;height:40px ;border-radius: 5px;"  placeholder="923001234567" />
                         <br />
                         <asp:RequiredFieldValidator runat="server" ControlToValidate="txtPhoneNumber"  ForeColor="Red" CssClass="text-danger" ErrorMessage="The Number field is required." />
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"  ErrorMessage="Mobile Number is not valid" ControlToValidate="txtPhoneNumber" max="12" min="1" ForeColor="Red" ValidationExpression="((\(\w{2}\) ?)|(\w{2}))?\d{3}\d{7}">
                    ...
                    <div class="form-group">
                        <div class="text-Design">
                            <asp:Label runat="server" CssClass="txtBold">Date Of Birth</asp:Label>
                        </div>
                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                    ...
                    <div class="form-group">
                        <div class="text-Design">
                        <asp:Label ID="lblResidentialAddress" runat="server" CssClass="txtBold" Text="Residential Address:"></asp:Label>
                         </div>
                    ...
                    <div class="col-md-6" style="background-color:#1f1e6a ;align-content:center; font-size-adjust:initial">
                    <%--<h1 class="login"><%: Title %></h1>--%>
                    <h1 class="login hr" style="align-content:center;height:70px ;padding-top:20px;padding-bottom:30px"> RSVP</h1>
                </div>
                        <%--<asp:Label ID="lbl" runat="server" Text="RSVP" style="font-display:block;box-sizing:content-box;background-color:#1f1e6a" CssClass="txtBold" ></asp:Label>--%>
                        <br />
                        <br />
                    <div class="form-group">
                        <div class="text-Design">
                        <asp:Label ID="Label1" runat="server" CssClass="txtBold" Text="I Would like to:"></asp:Label>
                        <br />
                        <br />
                    ...
                    <div class="form-group">
                        <div class="text-Design">
                        <asp:Label ID="lblAttend" runat="server" Text="Can you attend?"></asp:Label>
                            
                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtResidentialAddress" Display="Dynamic" CssClass="field-validation-error alert alert-danger" ErrorMessage="Company/Farm Name required" ValidationGroup="quizvalidation" Text=" *" SetFocusOnError="true" />--%>
                        <asp:RadioButton ID="RbtnAttend" runat="server" OnCheckedChanged="RbtnAttend_CheckedChanged" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="text-Design">
                        <asp:Label ID="lblNumberofPeople" runat="server" Text="Number of people attending?*"></asp:Label>
                            </div>
                        <br />
                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtResidentialAddress" Display="Dynamic" CssClass="field-validation-error alert alert-danger" ErrorMessage="Company/Farm Name required" ValidationGroup="quizvalidation" Text=" *" SetFocusOnError="true" />--%>
                        <asp:TextBox ID="txtNumberofPeople" CssClass="form-control" runat="server"></asp:TextBox>
                    </div>
                        <br />
                            ...
                            <table class="text-Design" text-align: center >
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style1">  <strong>Website</strong></td>
                                            ...
                                            <td ><%--<asp:CheckBox ID="chkBoxEarlyBird" runat="server" />--%>
                ...
                <asp:ImageButton ID="ImageButton1" runat="server" OnClick="ImageButton1_Click" Text="Register" ImageUrl="~/Images/Sign-Up-Blue.png" Width="120px" />
                ...
                <div class="col-md-3" style="width:2000px"></div>
    </div>
            </div>
