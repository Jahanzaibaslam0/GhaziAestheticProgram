<%@ Page Title="SignUp" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="WebFormsEmailSMS2FA.SignUp" %>
        ...
        <div class="borders">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="login hr">Create a new account</h1>
                </div>
            </div>
            <br>
            <div class="row">
