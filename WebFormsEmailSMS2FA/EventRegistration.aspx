<%@ Page Title="SignUp" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EventRegistration.aspx.cs" Inherits="WebFormsEmailSMS2FA.Sample" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  border-color:aquamarine;
    ...
    <br />
    <%--<h2><%: Title %>.</h2>--%>
    <div class="col-md-1" style="background-color:#0094ff"></div>
    <p class="text-danger">
  ...
  <%--  <div id="carousel-id" class="carousel slide slider" data-ride="carousel">
    ...
    <div class="container" style="background-color:#1f1e6a;border-style:dashed;border-width:medium;padding:10px,10px,500px,500px;border-spacing:initial ;align-content:start; font-style:normal;color:aliceblue" >
        <div class="borders" style="align-content:normal">
            <div class="row" >
                <div class="col-md-12" style="align-content:center" >
                    <%--<h1 class="login"><%: Title %></h1>--%>
                    <img src="Images/LOGO.png" class="img img-responsive" style="max-width:20%;min-width:10%" />
                    <h1 class="login hr" style="align-content:center;height:70px ;padding-top:50px;padding-bottom:30px">SIGN UP</h1>
                    <h1 class="login hr" style="align-content:center;height:70px ;padding-top:50px;padding-bottom:30px">INTERNATIONAL POULTRY EXPO-IPEX 2023</h1>
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group" >
                        ...
                        <asp:TextBox runat="server" ID="txtFirsName" type="text" CssClass="form-control" placeholder="First Name" />
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtFirsName" ForeColor="Red" Display="Dynamic" CssClass="field-validation-error alert alert-danger" ErrorMessage="name required" Text="*" SetFocusOnError="true" />
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtLastName" ForeColor="Red" Display="Dynamic" CssClass="field-validation-error alert alert-danger" ErrorMessage="name required" Text="*" SetFocusOnError="true" />
                    ...
                    <%--<div class="form-group">
                        <div class="text-Design">
                            <asp:Label runat="server"  CssClass="txtBold">DOB</asp:Label>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="text-Design">
                        <asp:Label ID="lblCompanyName" runat="server" CssClass="txtBold" Text="Company / Institution Name:"></asp:Label>
                            </div>
                    ...
                    <div visible="false" runat="server" class="RSVPDiv">
                        <br />
                        <br />
                    <h1 class="login hr" runat="server" visible="false" style="align-content:center;height:50px ;padding-top:30px;padding-bottom:10px"> RSVP</h1>

                    <br />
                    

                    
                        <%--<asp:Label ID="lblEmailSub" runat="server" Text="Email:"></asp:Label>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtResidentialAddress" Display="Dynamic" CssClass="field-validation-error alert alert-danger" ErrorMessage="Company/Farm Name required" ValidationGroup="quizvalidation" Text=" *" SetFocusOnError="true" />
                        <asp:CheckBox ID="chkboxEmailSub"  runat="server" />
                        
                    </div>

                    <div class="form-group">
                        <asp:Label ID="lblSMSSub" runat="server" Text="SMS:"></asp:Label>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtResidentialAddress" Display="Dynamic" CssClass="field-validation-error alert alert-danger" ErrorMessage="Company/Farm Name required" ValidationGroup="quizvalidation" Text=" *" SetFocusOnError="true" />
                        <asp:CheckBox ID="chkboxSMSSub"  runat="server" />
                        
                    </div>

                    <div class="form-group">
                        <asp:Label ID="lblWhatsappSub" runat="server" Text="Whatsapp:"></asp:Label>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtResidentialAddress" Display="Dynamic" CssClass="field-validation-error alert alert-danger" ErrorMessage="Company/Farm Name required" ValidationGroup="quizvalidation" Text=" *" SetFocusOnError="true" />
                        <asp:CheckBox ID="chkboxWhatsappSub" runat="server" />
                        
                    </div>--%>

                    <div class="form-group">
                        <div class="text-Design">
                        <asp:Label ID="lblAttend" runat="server" CssClass="txtBold" visible="false" Text="Are You Attend:"></asp:Label>
                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtResidentialAddress" Display="Dynamic" CssClass="field-validation-error alert alert-danger" ErrorMessage="Company/Farm Name required" ValidationGroup="quizvalidation" Text=" *" SetFocusOnError="true" />--%>
                        <asp:RadioButton ID="RbtnAttend" visible="false" runat="server" OnCheckedChanged="RbtnAttend_CheckedChanged" />
                            </div>
                    ...
                    <div class="form-group">
                        <div class="text-Design">
                        <asp:Label ID="lblNumberofPeople" runat="server" visible="false" CssClass="txtBold" Text="Number of People ?"></asp:Label>
                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtResidentialAddress" Display="Dynamic" CssClass="field-validation-error alert alert-danger" ErrorMessage="Company/Farm Name required" ValidationGroup="quizvalidation" Text=" *" SetFocusOnError="true" />--%>
                        <asp:TextBox ID="txtNumberofPeople" visible="false" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                    </div>

                    <%--<div class="form-group">
                        <div class="text-Design">
                            <table class="text-Design" text-align: center >
                                <tr class="text-center txtBold">
                                    
                                        <asp:Label ID="lblHearAbout" runat="server" Text="How did you hear about this event?" Width="400px"></asp:Label>
                                   
                                </tr>
                                <tr style="height:10px"></tr>
                                <tr>
                                    <td style="width:20px" ></td>
                                    <td class="auto-style1">  <strong>Website</strong></td>
                                    
                                        
                                        
                                            
                                                <asp:RadioButton ID="RbtnWebsite" runat="server" AutoPostBack="true" GroupName="SelectRegistration" OnCheckedChanged="RbtnWebsite_CheckedChanged" />
                                            </td>
                                ...
                                <tr>
                                    <td style="width:20px" ></td>
                                    <td class="auto-style1" ><strong>Friend</strong></td>
                                    <td >
                                     
                                        <asp:RadioButton ID="RbtnFriend" GroupName="SelectRegistration" AutoPostBack="true" runat="server" OnCheckedChanged="RbtnFriend_CheckedChanged"  />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:20px" ></td>
                                    <td class="auto-style1" ><strong>Newsletter</strong></td>
                                    <td >
                                      

                                        <asp:RadioButton ID="RbtnNewsletter" GroupName="SelectRegistration" AutoPostBack="true" runat="server" OnCheckedChanged="RbtnNewsletter_CheckedChanged"  />

                                    </td>
                                </tr>
                                <tr>
                                    <td style="width:20px" ></td>
                                    <td class="auto-style1" ><strong>Advertise</strong></td>
                                    <td >
                                        

                                        <asp:RadioButton ID="RbtnAdvert" GroupName="SelectRegistration" AutoPostBack="true" runat="server" OnCheckedChanged="RbtnAdvert_CheckedChanged" />
                    ...
                    <div class="form-group">
                        <div class="text-Design">
                        <asp:Label ID="lblHearAbout" visible="false" runat="server" CssClass="txtBold"  Text="How did you hear about this event?"></asp:Label>
                            </div>
                        <br />
                        <asp:DropDownList ID="DropDownSource" visible="false" CssClass="form-control" runat="server">
                                <asp:ListItem Text=""  Value="-1"></asp:ListItem>
                                <asp:ListItem Text="Website" Value="0"></asp:ListItem>
                                <asp:ListItem Text="Friend" Value="1"></asp:ListItem>
                                <asp:ListItem Text="NewsLetter" Value="2"></asp:ListItem>
                                <asp:ListItem Text="Advertisment" Value="3"></asp:ListItem>
                    ...
                    <div class="form-group">
                        <div class="text-Design">
                        <asp:Label ID="Label1" runat="server" visible="false" CssClass="txtBold" Text="I Would like to:"></asp:Label>
                        <br />
                        <br />
                        <asp:Label ID="lblEmailSub" runat="server" visible="false" Text="Email:"></asp:Label>
                           
                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtResidentialAddress" Display="Dynamic" CssClass="field-validation-error alert alert-danger" ErrorMessage="Company/Farm Name required" ValidationGroup="quizvalidation" Text=" *" SetFocusOnError="true" />--%>
                        <asp:CheckBox ID="chkboxEmailSub"  visible="false" runat="server" />
                        <asp:Label ID="lblSMSSub" visible="false" runat="server" Text="SMS:"></asp:Label>
                        <asp:CheckBox ID="chkboxSMSSub" visible="false" runat="server" />
                        <asp:Label ID="lblWhatsappSub" visible="false" runat="server" Text="Whatsapp:"></asp:Label>
                        <asp:CheckBox ID="chkboxWhatsappSub" visible="false" runat="server" />
                         </div>
                        </div>
                        </div>
                   ...
                   <%-- <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered table-condensed">
                                <tr class="text-center txtBold">
                                    <td colspan="2">
                                        <div class="text-Design">
                                        <asp:Label ID="lblHearAbout" runat="server" CssClass="txtBold" Text="How did you hear about this event?"></asp:Label>
                                         </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <strong>Website</strong>
                                            ...
                                            <td class="text-center">
                                                <asp:RadioButton ID="RbtnWebsite" runat="server" AutoPostBack="true" GroupName="SelectRegistration" OnCheckedChanged="RbtnWebsite_CheckedChanged1" />
                                            </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <asp:RadioButton ID="RbtnFriend" GroupName="SelectRegistration" AutoPostBack="true" runat="server" OnCheckedChanged="RbtnFriend_CheckedChanged1"  />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <asp:RadioButton ID="RbtnNewsletter" GroupName="SelectRegistration" AutoPostBack="true" runat="server" OnCheckedChanged="RbtnNewsletter_CheckedChanged1"  />
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <asp:RadioButton ID="RbtnAdvert" GroupName="SelectRegistration" AutoPostBack="true" runat="server" OnCheckedChanged="RbtnAdvert_CheckedChanged1" />
                    ...
                    <div class="form-group">
                        <div class="text-Design">
                        <asp:Label ID="LblComment" runat="server" CssClass="txtBold" Text="Comment:"></asp:Label>
                            </div>
                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtResidentialAddress" Display="Dynamic" CssClass="field-validation-error alert alert-danger" ErrorMessage="Company/Farm Name required" ValidationGroup="quizvalidation" Text=" *" SetFocusOnError="true" />--%>
                    ...
                    <div class="form-group">
                        <div class="text-Design">
                        <asp:ImageButton ID="ImageButton1" runat="server" OnClick="ImageButton1_Click1" Text="Register" ImageUrl="~/Images/Sign-Up-Blue.png" Width="120px" />
