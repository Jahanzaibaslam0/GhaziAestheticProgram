                    ...
                    //{
                        ...
                        using (SqlConnection sqlConn = new SqlConnection(sConnectionString))
                        {
                            ...
                            if (count > 0)
                            {
                                ...
                                {
                                    string query1 = @"select distinct R.ID,R.FirstName from UserRegistrationDetail R inner join Payment P on R.ID=P.UserID and R.Email=P.EmailAddress where P.PaymID='" + EmailUser + "'";
