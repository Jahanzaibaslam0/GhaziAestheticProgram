                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="text-Design">
                            <asp:Label runat="server" AssociatedControlID="Email" CssClass="txtBold">Email</asp:Label>
                        </div>
...
<%--                        <asp:Label runat="server" AssociatedControlID="Password" Font-Size="Small" >At least One Special Charactar, One Digit and On Upper Case:example(Ali@123)</asp:Label>--%>
                ...
                <asp:ImageButton ID="ImageButton1" runat="server" OnClick="CreateUser_Click" Text="Register" ImageUrl="~/Images/Sign-Up-Blue.png" Width="120px" />
