<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="WebForm8.aspx.cs" Inherits="WebFormsEmailSMS2FA.WebForm8" %>
...
@media (min-width: 1200px)
{
  ...
  <div class="carousel-inner">
    <div class="item active">
          <video autoplay="true" class="img img-responsive sVideo slide" id="slider-first-video" muted="true" poster="poster.JPG">
                            <source src="Video/GAP800.mp4" type="video/mp4">
                            </video>
                 ...
                 <asp:ImageButton ID="ImageButton3" runat="server"  Text="Register" CssClass="img img-responsive btn" ImageUrl="~/GAPImage/Sign In.png" Width="200px" />
    <asp:ImageButton ID="ImageButton4" runat="server"   Text="Register" CssClass="img img-responsive btn" ImageUrl="~/GAPImage/Registration.png" Width="200px" />
...
<div class="container1">
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6">
            <h3 class="learn">Learn more about the GAP</h3>
...
<br>
                    We aim to spread awareness and offer one of the most comprehensive product portfolios having scientific legacy and high quality, across the country</p>
        </div>
    </div>
    ...
    <div class="row">
            <div class="col-lg-6 col-md-6">
                    <h3 class="learn">Learn more about the GAPMedical Education, 24/7</h3>
