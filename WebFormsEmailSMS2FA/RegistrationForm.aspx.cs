    ...
    public partial class RegistrationForm1 : System.Web.UI.Page
    {
        ...
        public void InsertDataInDB()
        {
            ...
            else
            {
                ...
                int Payment = 0;
                string sQuery = string.Format("INSERT INTO UserRegistrationDetail (FirstName,LastName,Speciality,Qualification,PracticeLocation,VisitorType,Province,City,Mobile,Pmdc,Email,CNIC,Image,Status,ZipCode,ClinicAddress,Institute,Affiliation,PrivateClinic,BasicFillersHandsW,BasicBotulinumToxinAW,ThreadsHandsW,MonoThreadsFaceNeckW,AdvanceFillersHandsW,AdvanceBotulinumToxinAW,LaserCourseESCAD,PaymentMode,Registration,RegistrationEarlyBird,RegistrationNormalReg,RegistrationOnSite,RegistrationFees,FeesinWords,Discount,Title) Values (@FirstName,@LastName,@Speciality,@Qualification,@PracticeLocation,@VisitorType,@Province,@City,@Mobile,@Pmdc,@Email,@CNIC,@Image,@Status,@ZipCode,@ClinicAddress,@Institute,@Affilation,@PrivateClinic,@BasicFillersHandsW,@BasicBotulinumToxinAW,@ThreadsHandsW,@MonoThreadsFaceNeckW,@AdvanceFillersHandsW,@AdvanceBotulinumToxinAW,@LaserCourseESCAD,@PaymentMode,@Registration,@RegistrationEarlyBird,@RegistrationNormalReg,@RegistrationOnSite,@RegistrationFees,@FeesinWords,@Discount,@Title)");
                ...
                email.Email1(Session["User"].ToString(), "REGISTRATION SUBMISSION EMAIL", txtName.Text.Trim().ToUpper(),txtGuardian.Text.Trim().ToUpper());
