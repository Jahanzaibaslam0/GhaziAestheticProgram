<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GAPRegistrationForm.aspx.cs" Inherits="WebFormsEmailSMS2FA.OnSideRegistrationForm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="row headerRow">
            <div class="col-md-4">
                <h3 class="scndPaads text-center"> GHAZI AESTHETIC PROGRAM</h3>
                <br>
                <p class="text-center text-style">
                    GHAZI HOSUE, B-35, AL-HILAL SOCIETY K.D.A SCHEME NO.7, UNIVERSITY ROAD,<br>
                    KARACHI-SINDH 74800 PAKISTAN<br>
                    92-21-34853004-6
                    <br>

                    gap@ghazihealthcare.com
                </p>
            </div>
            <div class="col-md-5">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtMobileNo" CssClass="form-control" placeholder="0923001234567" TextMode="Number" runat="server"></asp:TextBox>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtEmailId" CssClass="form-control" TextMode="Email" runat="server" placeholder="example@yahoo.com" ></asp:TextBox>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtPostalCode" Display="Dynamic" CssClass="field-validation-error alert alert-danger" ErrorMessage="POSTAL CODE REQUIRED"  Text=" *" SetFocusOnError="true" />--%>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <asp:Label ID="lblRegistrationErrorType" runat="server" Text="Registration Error Type:"></asp:Label>
                        <asp:DropDownList ID="DropDownRegError" CssClass="form-control" runat="server">
                            <asp:ListItem Text="" Value="-1"></asp:ListItem>
                            <asp:ListItem Text="Incomplete Information" Value="0"></asp:ListItem>
                            <asp:ListItem Text="Data Validation Required" Value="1"></asp:ListItem>
                            <asp:ListItem Text="Profile Image Required" Value="2"></asp:ListItem>
                            <asp:ListItem Text="Personal Detail Required" Value="3"></asp:ListItem>
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        <asp:Label ID="lblRegistrationErrorComment" runat="server" Text="Registration Error Comment:"></asp:Label>
                        <asp:TextBox ID="txtRegistrationErrorComment" CssClass="form-control" runat="server"></asp:TextBox>
                    </div>
                </div>
                </div>
                            ...
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr>
                                    <td>For Early birds <strong>(till 15th June) Fee: PKR 10,000/-</strong></td>
                                            ...
                                            <td class="text-center"><%--<asp:CheckBox ID="chkBoxEarlyBird" runat="server" />--%>
                                                <asp:RadioButton ID="RbtnRegistrationEarlyBird" runat="server" AutoPostBack="true" GroupName="SelectRegistration" OnCheckedChanged="RbtnRegistrationEarlyBird_CheckedChanged" />
                                            </td>
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <asp:Label ID="lblAccountName" runat="server" Text="Ghazi Aesthetic Program"></asp:Label>
                                                    ...
                                                    <br>
                                                        </i>GHAZI HOSUE, B-35, AL-HILAL SOCIETY K.D.A SCHEME NO.7, UNIVERSITY ROAD,
                                                    </p>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p>I authorize GAP to charge for my conference registration fees and hand-on training workshop(s) as requested in the total amount of:</p>
