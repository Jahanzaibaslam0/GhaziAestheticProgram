...
{
    public partial class UpdateRegistrationForm2 : System.Web.UI.Page
    {
        int Payment = 0;
        string PaymentMode = "";
        int Discount = 0;
            ...
            if (!IsPostBack)
            {
                if (Session["User"].ToString() == "NOSHINARSHAD@GMAIL.COM")
                {
                    ...
                    while (dReader.Read())
                    {
                        ...
                        DropDownProvince.Items.FindByValue(dReader.GetSqlValue(6).ToString()).Selected = true;
                        ...
                        DropDownVisitor.Items.FindByValue(dReader.GetSqlValue(13).ToString()).Selected = true;
                        ...
                        if (dReader.GetSqlValue(22).ToString() == "True")
