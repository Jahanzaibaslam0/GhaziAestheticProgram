<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OnsiteRegistrationValidation.aspx.cs" Inherits="WebFormsEmailSMS2FA.OnsiteRegistrationValidation" %>
                                        ...
                                        <table class="table table-bordered table-condensed">
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:CheckBox ID="chkAdvBotulin" CssClass="alignCheck" Text="Botulin um Toxin-A" runat="server" OnCheckedChanged="chkAdvBotulin_CheckedChanged" />
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <asp:RadioButton ID="RbtnOnline" GroupName="PaymentMode" AutoPostBack="false" Text="Online Deposit" runat="server" OnCheckedChanged="RbtnOnline_CheckedChanged"   />
        <br />
      <%--<asp:CheckBox ID="chkBoxOnline" Text="Online Deposite" runat="server" />--%>
        <asp:RadioButton ID="RbtnBankDraft" GroupName="PaymentMode" AutoPostBack="false" Text="Bank Draft/Pay Order" runat="server" OnCheckedChanged="RbtnBankDraft_CheckedChanged"   />
        <%--<asp:CheckBox ID="chkBoxBank" Text="Bank Draft/Pay Order" runat="server" />--%>
        <br />
        <asp:RadioButton ID="RbtnCash" GroupName="PaymentMode" AutoPostBack="false" Text="Cash (Only on Sites on Conference Day)" runat="server" OnCheckedChanged="RbtnCash_CheckedChanged"   />
        ...
        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Images/Update-Blue.png" OnClick="Update_Click2" Width="150px" />
        <asp:Button ID="Button1" runat="server" Text="Cancel" Width="150px" Height="50px" ForeColor="White" BackColor="#ff0000" OnClick="Button1_Click1" />
