<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeedbackShahidJamil.aspx.cs" Inherits="WebFormsEmailSMS2FA.FeedbackShahidJamil" %>
...
<body>
    <form runat="server">
        ...
        <div class="row">
            <div class="col-md-12">
                <img src="GAPImage/G.A.PT Feed Back Shahid Jamil-2.png" alt="Ghazi-Healthcare" class="img img-responsive"/>
            </div>
            <%--<div class="col-md-6">
...
<div class="row">
        <div class="col-md-6">
            <h4 class="facial">Facial Analysis</h4>
        </div>
        <div class="col-md-6">
        </div>
    </div>
            ...
            <tr>
                <td style="border:1px solid #034ea2"> The speaker delivered the lecture effectively</td>
                    ...
                    <asp:RadioButtonList ID="AOFSpeaker" runat="server" CssClass="text-center" RepeatDirection="Horizontal" Width="100%" BorderStyle="None">
                      ...
                      <div class="row">
            <div class="col-md-6">
                <h4 class="facial">Peri Orbital Filler Injection Technique</h4>
            </div>
            <div class="col-md-6">
            </div>
        </div>
        ...
        <table class="table table-bordered table-condensed table-stripped">
            ...
            <tr>
                ...
                <th colspan="5" style="border-right:1px solid #034ea2;border-bottom:1px solid #034ea2">
                    ...
                    <asp:RadioButtonList ID="PeriOrbitalFillerContent" runat="server" CssClass="text-center" RepeatDirection="Horizontal" Width="100%" BorderStyle="None">
            ...
            <tr>
                <td style="border:1px solid #034ea2"> The speaker delivered the lecture effectively</td>
                    ...
                    <asp:RadioButtonList ID="PeriOrbitalFillerSpeaker" runat="server" CssClass="text-center" RepeatDirection="Horizontal" Width="100%" BorderStyle="None">
                ...
                <div class="row">
            <div class="col-md-6">
                <h4 class="facial">Lip Injection Technique</h4>
            </div>
            <div class="col-md-6">
            </div>
        </div>
        ...
        <table class="table table-bordered table-condensed table-stripped">
            ...
            <tr>
                ...
                <th colspan="5" style="border-right:1px solid #034ea2;border-bottom:1px solid #034ea2">
                    ...
                    <asp:RadioButtonList ID="LipInjectionTechniqueContent" runat="server" CssClass="text-center" RepeatDirection="Horizontal" Width="100%" BorderStyle="None">
            ...
            <tr>
                <td style="border:1px solid #034ea2"> The speaker delivered the lecture effectively</td>
                    ...
                    <asp:RadioButtonList ID="LipInjectionTechniqueSpeaker" runat="server" CssClass="text-center" RepeatDirection="Horizontal" Width="100%" BorderStyle="None">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtMobileNumber" placeholder="0923001234567" TextMode="Number" MaxLength="13" Width="100%" runat="server"></asp:TextBox>
                </div>
            </div>
            <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Please Enter Valid Email ID" ValidationGroup="Feedback" ControlToValidate="txtEmail" CssClass="requiredFieldValidateStyle" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*">
                            ...
                            <asp:TextBox ID="txtEmail" Width="100%" TextMode="Email" runat="server" placeholder="example@yahoo.com"></asp:TextBox>
                        </div>
            </div>
            <div class="col-md-4">
                    <div class="form-group">
                            ...
                            <asp:TextBox ID="txtCity" Width="100%" ValidationGroup="Feedback" runat="server"></asp:TextBox>
                        </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Submit" ValidationGroup="Feedback" OnClick="Button1_Click"  />
