...
{
    public class RegistrationSubmissionEmail
    {
...
<br><br>
    <strong style='margin-left: 10%;width: 80%;font-family: sans-serif;font-size: 15px;'>Dear:Dr. " + FName + " " + LName + @"</strong>
...
<br>
<br>
Please note that your registration application is under the process of validation. After it’s confirmation you may proceed to payment for completion of your registration. 
<br>
<br>
